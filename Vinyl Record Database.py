...
Interactive program allows users to look up records in collection by Artist Name, Album Name, Genre, Record Label, Song Title, Catalog Number, Release Year and Print Year
Add new records, delete records
"""
...
#ask user if they would like to return to main menu or quit, returns bool value
def return_or_quit():
